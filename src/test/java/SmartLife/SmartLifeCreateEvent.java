...
public class SmartLifeCreateEvent {
...
@Test
    ...
    driver.findElement(By.xpath("//*[@id=\"mat-input-0\"]")).sendKeys("polezniybess@gmail.com");
    driver.findElement(By.xpath("//*[@id=\"mat-input-1\"]")).sendKeys("Qwerty123");
    Thread.sleep(3000);
    driver.findElement(By.xpath("/html/body/app-root/section/app-slp-website/section/app-home/div/div/section[1]/div[2]/div[2]/div/mat-tab-group/div/mat-tab-body[1]/div/form/div[3]/div[2]/button")).click();
    ...
    driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/mat-dialog-container/slp-create-event-new-dialog/div/mat-horizontal-stepper/div[2]/div[1]/form/div[5]/button/span")).click(); //Next button
    Thread.sleep(3000);

    driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/mat-dialog-container/slp-create-event-new-dialog/div/mat-horizontal-stepper/div[2]/div[2]/form/div[2]/div[3]/mat-checkbox/label/div")).click(); //online evemt checkbox
    Thread.sleep(1000);
    ...
    Thread.sleep(1000);
    driver.findElement(By.xpath("//*[@id=\"cdk-step-content-0-3\"]/div[3]/button[2]/span")).click(); //create event
    Thread.sleep(2000);
